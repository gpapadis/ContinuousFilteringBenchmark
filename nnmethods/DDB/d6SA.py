...
left_df = pd.read_csv(main_dir + 'D6Bemb.csv', sep=deli)
left_df = left_df[['Id', 'Clean Ag.Value']]
left_df.columns = ['id', 'Clean Ag.Value']
right_df = pd.read_csv(main_dir + 'D6Aemb.csv', sep=deli)
right_df = right_df[['Id', 'Clean Ag.Value']]
right_df.columns = ['id', 'Clean Ag.Value']
golden_df = pd.read_csv(main_dir + 'D6groundtruthRev.csv', sep=deli)
