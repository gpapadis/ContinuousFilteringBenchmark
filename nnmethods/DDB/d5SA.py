...
left_df = pd.read_csv(main_dir + "D5Bemb.csv", sep=deli)
left_df = left_df[['Id', 'Clean Ag.Value']]
left_df.columns = ['id', 'Clean Ag.Value']
right_df = pd.read_csv(main_dir + "D5Aemb.csv", sep=deli)
right_df = right_df[['Id', 'Clean Ag.Value']]
right_df.columns = ['id', 'Clean Ag.Value']
golden_df = pd.read_csv(main_dir + "D5groundtruthRev.csv", sep=deli)
