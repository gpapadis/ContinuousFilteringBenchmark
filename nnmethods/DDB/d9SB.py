...
left_df = pd.read_csv(main_dir + "D9Bemb.csv", sep=deli)
left_df = left_df[['Id', 'Clean Title']]
left_df.columns = ['id', 'Clean Title']
left_df['Clean Title'] = left_df['Clean Title'].astype(str)
right_df = pd.read_csv(main_dir + "D9Aemb.csv", sep=deli)
right_df = right_df[['Id', 'Clean Title']]
right_df.columns = ['id', 'Clean Title']
right_df['Clean Title'] = right_df['Clean Title'].astype(str)
golden_df = pd.read_csv(main_dir + "D9groundtruthRev.csv", sep=deli)
