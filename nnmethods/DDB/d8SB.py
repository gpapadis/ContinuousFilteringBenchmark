...
left_df = pd.read_csv(main_dir + 'D8Bemb.csv', sep=deli)
left_df = left_df[['Id', 'Clean Title']]
left_df.columns = ['id', 'Clean Title']
right_df = pd.read_csv(main_dir + 'D8Aemb.csv', sep=deli)
right_df = right_df[['Id', 'Clean Title']]
right_df.columns = ['id', 'Clean Title']
golden_df = pd.read_csv(main_dir + 'D8groundtruthRev.csv', sep=deli)
