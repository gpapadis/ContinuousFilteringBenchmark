...
if __name__ == '__main__':
    ...
    for column in ['Embedded Title', 'Embedded Clean Ag.Value']:
          ...
          for L in range(25,26,1):
              for k in range(1,2):
                  for cpdim in range(1,2):
                      ...
                      params_cp.storage_hash_table = falconn.StorageHashTable.LinearProbingHashTable #BitPackedFlatHashTable #
