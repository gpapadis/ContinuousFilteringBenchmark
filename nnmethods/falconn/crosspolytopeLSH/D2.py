...
if __name__ == '__main__':
    ...
    for column in ['Embedded Clean Name', 'Embedded Clean Ag.Value']:
     for iteration in range(0, 10):
          ...
          out.write("LSH \t dist Funct \t num tables \t num hash funct \t last cp dimension \t num probes \t index time \t query time \t true matches \t all candidates \t all matches \t Index \t Query \t Indexmemory \t Searchmemory \t storage\n")
          out.close()
          for L in range(55,56):
              for k in range(2,3):
                  for cpdim in range(9,10):
                      print("now starting")
                      ...
                      if column == "Embedded Clean Name":
                          ...
                          number_of_probes = 43
                      elif column == "Embedded Clean Ag.Value":
                          print(column)
                          number_of_tables = 60
                          cpd = 256
                          number_of_functions = 1
                      ...
                      params_cp.storage_hash_table = falconn.StorageHashTable.BitPackedFlatHashTable  #LinearProbingHashTable #
