          ...
          for L in range(5,6,2):
              for k in range(2,3):
                  for cp in range(1,2,1):                    
                      ...
                      out = open(outstring, 'a')
                      out.write("{} \t {} \t {} \t {} \t {} \t {} \t {} \t {} \t {} \t {} \t {} \t {} \t {} \t {} \t {} \t {} \n".format(params_cp.lsh_family, params_cp.distance_function, params_cp.l, params_cp.k, params_cp.last_cp_dimension, number_of_probes, constructtime, querytime, finscore, fullCandidates, len(gt), len(dataset), len(queries), indexm, querym, storage))
                      out.close()
