 ...
 * @author Georgios
 */
public class TopKSchemaBasedJoin extends AbstractJoin {

    public static void main(String[] args) {
        int[] K = {1, 3, 3, 1, 6, 1, 70, 6, 1, 98};

        boolean[] reversed = {true, false, true, false, true, true};
        boolean[] preprocessing = {true, true, true, false, true, false};
        ...
        String[] datasetsD1Rv = {"restaurant2Profiles", "buyProfiles", "gpProfiles", "acmProfiles", "amazonProfiles2", "scholarProfiles"};
        String[] datasetsD2Rv = {"restaurant1Profiles", "abtProfiles", "amazonProfiles", "dblpProfiles", "walmartProfiles", "dblpProfiles2"};
        ...
        Tokenizer[] tokenizer = {Tokenizer.CHARACTER_FIVEGRAMS, Tokenizer.CHARACTER_BIGRAMS, Tokenizer.CHARACTER_TRIGRAMS, Tokenizer.CHARACTER_TRIGRAMS, Tokenizer.CHARACTER_BIGRAMS, Tokenizer.CHARACTER_BIGRAMS_MULTISET};
        ...
        for (int datasetId = 0; datasetId < groundtruthDirs.length; datasetId++) {
            ...
            String sourcePath = mainDirs[dirId] + sPath + "_" + attributes[datasetId];
            ...
            String targetPath = mainDirs[dirId] + tPath + "_" + attributes[datasetId];
