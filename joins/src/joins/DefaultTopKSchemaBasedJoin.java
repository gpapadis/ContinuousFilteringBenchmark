 ...
 * @author Georgios
 */
public class DefaultTopKSchemaBasedJoin extends AbstractJoin {

    public static void main(String[] args) {
        int K = 5;
        boolean[] reversed = {true, false, true, false, true, true};
        
        String mainDir = "/home/gap2/Documents/blockingNN/data/preprocessedSB/";
        String[] attributes = {"Name", "Name", "Title", "Title", "Title", "Title", "Title"};
...
//        SimilarityFunction simFunction = SimilarityFunction.COSINE_SIM;
        ...
        for (int datasetId = 0; datasetId < groundtruthDirs.length; datasetId++) {
            ...
            String sourcePath = mainDir + sPath + "_" + attributes[datasetId];
            ...
            String targetPath = mainDir + tPath + "_" + attributes[datasetId];
