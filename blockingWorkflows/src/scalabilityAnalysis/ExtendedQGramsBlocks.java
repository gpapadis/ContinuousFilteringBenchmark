    ...
    public static void main(String[] args) {
        ...
        for (int datasetId = 0; datasetId < datasets.length; datasetId++) {
            ...
            for (int iterations = 0; iterations < ITERATIONS; iterations++) {
                ...
                IBlockBuilding blbuMethod = new ExtendedQGramsBlocking();
                ...
                bf.setNumberedGridConfiguration(bfcId);
                final List<AbstractBlock> bfBlocks = bf.refineBlocks(new ArrayList(blocks));

                IBlockProcessing bpMethod = new WeightedEdgePruning();
                bpMethod.setNumberedGridConfiguration(mbcId);
                final List<AbstractBlock> mbBlocks = bpMethod.refineBlocks(new ArrayList(bfBlocks));
