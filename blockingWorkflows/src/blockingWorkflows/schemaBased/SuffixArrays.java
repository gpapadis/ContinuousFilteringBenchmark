...
public class SuffixArrays {
    ...
    public static void main(String[] args) {
        ...
        int[] bbConfId = new int[]{49, 170, 225, 480, 161, 445, 445, 456, 499, 499};
        int[] mbConfId = new int[]{1, 5, 5, 5, 2, 1, 0, 5, 1, 1};
        ComparisonCleaningMethod[] mbAlg = {ComparisonCleaningMethod.RECIPROCAL_CARDINALITY_NODE_PRUNING,
            ...
            ComparisonCleaningMethod.BLAST, ComparisonCleaningMethod.CARDINALITY_NODE_PRUNING, 
            ComparisonCleaningMethod.BLAST, ComparisonCleaningMethod.BLAST, ComparisonCleaningMethod.WEIGHTED_EDGE_PRUNING,
            ComparisonCleaningMethod.WEIGHTED_NODE_PRUNING, ComparisonCleaningMethod.WEIGHTED_NODE_PRUNING};
