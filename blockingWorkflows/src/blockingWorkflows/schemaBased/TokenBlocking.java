...
public class TokenBlocking {
    ...
    public static void main(String[] args) {
        ...
        int[] bfConfId = new int[]{35, 34, 31, 9, 29, 33, 24, 25, 20, 37};
        int[] mbConfId = new int[]{1, 5, 5, 2, 1, 1, 1, 5, 1, 1};
        ComparisonCleaningMethod[] mbAlg = {ComparisonCleaningMethod.RECIPROCAL_CARDINALITY_NODE_PRUNING,
            ...
            ComparisonCleaningMethod.RECIPROCAL_WEIGHTING_NODE_PRUNING, ComparisonCleaningMethod.BLAST,
            ComparisonCleaningMethod.BLAST, ComparisonCleaningMethod.BLAST, ComparisonCleaningMethod.BLAST,
            ComparisonCleaningMethod.RECIPROCAL_CARDINALITY_NODE_PRUNING, ComparisonCleaningMethod.WEIGHTED_EDGE_PRUNING};
