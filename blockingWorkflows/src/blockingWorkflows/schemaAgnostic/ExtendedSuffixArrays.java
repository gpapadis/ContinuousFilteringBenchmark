...
public class ExtendedSuffixArrays {
    ...
    public static void main(String[] args) {
        ...
        int[] bbConfId = new int[]{10, 46, 419, 35, 194, 429, 114, 119, 419, 498};
        int[] mbConfId = new int[]{0, 0, 0, 5, 0, 0, 0, 0, 5, 5};
        ComparisonCleaningMethod[] mbAlg = {ComparisonCleaningMethod.RECIPROCAL_WEIGHTING_NODE_PRUNING, ComparisonCleaningMethod.BLAST,
            ComparisonCleaningMethod.WEIGHTED_NODE_PRUNING, ComparisonCleaningMethod.BLAST, ComparisonCleaningMethod.RECIPROCAL_WEIGHTING_NODE_PRUNING,
            ComparisonCleaningMethod.RECIPROCAL_WEIGHTING_NODE_PRUNING, ComparisonCleaningMethod.BLAST, ComparisonCleaningMethod.RECIPROCAL_WEIGHTING_NODE_PRUNING,
            ComparisonCleaningMethod.RECIPROCAL_CARDINALITY_NODE_PRUNING, ComparisonCleaningMethod.CARDINALITY_NODE_PRUNING};
