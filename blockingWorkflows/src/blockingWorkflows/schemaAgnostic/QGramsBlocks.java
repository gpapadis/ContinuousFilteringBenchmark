...
public class QGramsBlocks {
    ...
    public static void main(String[] args) {
        ...
        boolean[] blockPurging = {true, false, true, true, false, false, false, true, false, true};


        int[] qConfId = new int[]{2, 2, 4, 4, 4, 4, 4, 3, 1, 2};
        int[] bfConfId = new int[]{12, 12, 34, 3, 16, 34, 8, 10, 20, 37};
        int[] mbConfId = new int[]{1, 0, 5, 4, 0, 2, 2, 0, 5, 5};
        ComparisonCleaningMethod[] mbAlg = {ComparisonCleaningMethod.RECIPROCAL_CARDINALITY_NODE_PRUNING, 
            ...
            ComparisonCleaningMethod.CARDINALITY_EDGE_PRUNING, ComparisonCleaningMethod.WEIGHTED_EDGE_PRUNING,
