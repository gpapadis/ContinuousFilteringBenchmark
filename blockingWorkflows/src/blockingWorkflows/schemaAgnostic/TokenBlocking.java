...
public class TokenBlocking {
    ...
    public static void main(String[] args) {
        ...
        boolean[] blockPurging = {false, false, true, true, true, false, false, false, true, false};

        int[] bfConfId = new int[]{1, 34, 36, 8, 39, 38, 13, 8, 24, 31};
        int[] mbConfId = new int[]{0, 5, 5, 4, 1, 1, 1, 0, 3, 5};
        ComparisonCleaningMethod[] mbAlg = {ComparisonCleaningMethod.WEIGHTED_EDGE_PRUNING, ComparisonCleaningMethod.BLAST,
            ComparisonCleaningMethod.CARDINALITY_NODE_PRUNING, ComparisonCleaningMethod.RECIPROCAL_CARDINALITY_NODE_PRUNING,
